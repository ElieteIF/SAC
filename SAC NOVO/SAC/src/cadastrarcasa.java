...
public class cadastrarcasa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("N° DA CASA");

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/CADASTROCASA.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int cep = Integer.parseInt(jTextField4.getText());
        String bairro = (jTextField2.getText());
        String rua = jTextField5.getText();
        int Ncasa = Integer.parseInt (jTextField6.getText());
        String complemento = jTextField3.getText();
        ConexaoEndereco SistemaAlarme = new ConexaoEndereco();
        SistemaAlarme.Endereco(cidade, cep, bairro, rua, Ncasa, complemento);
        
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
          new Perfil().show();  //nome seria a classe principal que vc quer voltar
        dispose(); 
